...
bookingRoute.post("/api/payment", async (req, res) => {
    try {
...
bookingRoute.get("/api/payment/sellerId", verifyToken, verifySeller, async (req, res) => {
    try {
...
bookingRoute.get("/api/payment/buyerId", verifyToken, verifyBuyer, async (req, res) => {
    try {
